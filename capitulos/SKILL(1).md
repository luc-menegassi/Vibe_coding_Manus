---
name: deep-research
description: Conduct in-depth research across multiple sources and synthesize findings. Use when the user requests in-depth or comprehensive research, an investigation, or an in-depth research report grounded in credible sources.
---
...
- Use newly discovered facts to generate follow-up searches and refine the research direction
...
When writing the final research report, MUST also read and follow the `technical-writing` skill (`/home/ubuntu/skills/technical-writing/SKILL.md`); it defines how the report must be written and formatted.
